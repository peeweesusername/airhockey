...
class ThePuck extends BodyComponent with Draggable {
  ...
  ThePuck({required this.position, required this.radius});
  ...
  Body createBody() {
    ...
    final bodyDef = BodyDef(position: position, linearVelocity: Vector2.zero(), type: BodyType.dynamic, userData: mycontact);
